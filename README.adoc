...
=== example-jmolecules
This example demonstrates JMolecules Identifier and ValueObject integration.
...
NOTE: This example is currently **not working with Spring Boot 4**. We have to wait for a new version of `com.epages:restdocs-api-spec-mockmvc` that supports Spring Boot 4. See https://github.com/ePages-de/restdocs-api-spec/issues/289
